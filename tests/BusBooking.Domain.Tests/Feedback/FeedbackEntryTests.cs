...
public sealed class FeedbackEntryTests
{
    ...
    public void Create_ShouldSetAllFields()
    {
        ...
        var entry = FeedbackEntry.Create(userId, bookingId, scheduleId, 4, "Good service.", FeedbackCategory.Service);
    ...
    public void Create_WithRatingBelow1_ShouldThrow()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            FeedbackEntry.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), 0, "Bad", FeedbackCategory.Service));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            FeedbackEntry.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), 6, "Too good", FeedbackCategory.General));
    }
    ...
    public void Create_WithEmptyComment_ShouldThrow()
    {
        Assert.Throws<ArgumentException>(() =>
            FeedbackEntry.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), 3, "", FeedbackCategory.General));
    }
    ...
    public void Create_WithCommentOver1000Chars_ShouldThrow()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            FeedbackEntry.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), 3, longComment, FeedbackCategory.General));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            FeedbackEntry.Create(Guid.Empty, Guid.NewGuid(), Guid.NewGuid(), 3, "ok", FeedbackCategory.General));
    }

    [Fact]
    public void Update_ShouldMutateFields()
    {
        var entry = FeedbackEntry.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), 3, "OK", FeedbackCategory.Service);
