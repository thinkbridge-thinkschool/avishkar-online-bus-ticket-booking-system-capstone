...
{
    /// <inheritdoc />
    public partial class Phase1_AddDualAuthIdentityTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LocalCredentials_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserRoles_UserId_Role",
                table: "AppUserRoles",
                columns: new[] { "AppUserId", "RoleName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalLogins_Provider_Key",
                table: "ExternalLogins",
                columns: new[] { "LoginProvider", "ProviderKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LocalCredentials_AppUserId",
